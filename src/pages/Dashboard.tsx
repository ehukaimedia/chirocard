...
import { Plus, Calendar as CalendarIcon, User, Info, ShieldCheck, CheckCircle, ChevronRight, Pencil, Bell, ClipboardList } from "lucide-react";
                    ...
                    <div className="space-y-3">
                        {sessions === undefined ? (
                            ...
                            <motion.div
                                ...
                                className="text-center py-10 bg-zinc-50 dark:bg-zinc-900/50 rounded-2xl border border-dashed border-zinc-200 dark:border-zinc-800"
                            >
                                <ClipboardList className="w-10 h-10 text-zinc-300 mx-auto mb-3" />
                                <p className="text-zinc-500 text-sm font-medium mb-1">No sessions yet</p>
                                <p className="text-zinc-400 text-xs">Tap "New Session" above to record your first visit.</p>
                            </motion.div>
                        ) : (
